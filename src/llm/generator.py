...
#    Updated: 2026/08/12 07:02:19 by nyramana        ###   ########.fr        #
#                                                                             #
# *************************************************************************** #
...
class ArgumentGenerator:
    ...
    def generate_from_list(self, prompt: str, allowed_tokens: list[list[int]]) -> str:
        result: list[int] = []
        i = 0
        while True:
            candidates = [
                seq
                for seq in self._valid_type
